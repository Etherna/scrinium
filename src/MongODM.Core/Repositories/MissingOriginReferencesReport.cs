...
namespace Etherna.MongODM.Core.Repositories
{
    ...
    /// one report per scanned reference element path, and the paths the scan can't verify.
    /// </summary>
    public class MissingOriginReferencesReport(
        IReadOnlyCollection<MissingOriginReferencesPathReport> pathReports,
        IReadOnlyCollection<string> unverifiableElementPaths)
    {
        // Properties.
        /// <summary>
        /// One report per scanned reference element path, the clean ones included.
        /// </summary>
        public IReadOnlyCollection<MissingOriginReferencesPathReport> PathReports { get; } = pathReports;
