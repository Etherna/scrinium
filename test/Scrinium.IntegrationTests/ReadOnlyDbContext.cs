...
namespace Etherna.MongODM.IntegrationTests
{
    ...
    /// <summary>
    /// A fully read-only db context, consuming the shared database owned by
    /// <see cref="SecondDbContext"/>: registered with <c>IsReadOnly</c> on its options.
    /// </summary>
    internal sealed class ReadOnlyDbContext : DbContext, IReadOnlyDbContext
    {
        // Properties.
        //repositories
