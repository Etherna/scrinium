...
{
    public interface ISeedObserverTwoDbContext : IDbContext
    { }
    ...
    /// </summary>
    internal sealed class SeedObserverTwoDbContext(
        ConcurrentDictionary<string, IDictionary<object, object?>?> seedingObservations)
        : DbContext, ISeedObserverTwoDbContext
    {
        ...
        {
            seedingObservations[nameof(SeedObserverTwoDbContext)] = Engine.ExecutionContext.Items;
